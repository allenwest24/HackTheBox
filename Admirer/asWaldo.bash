...
.
.
// Obviously gunna check that out
.
.
.
...
.
.
// Call to a script called backup.py
// Now shit gets complicated.
// going to be using a netcat on terminal2 and make a shutil.py to get the system to call backup.py
.
.
.
